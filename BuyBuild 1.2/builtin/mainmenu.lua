...
function tabbuilder.tab_server()
	...
	local retval = 
		...
		"checkbox[0.5,0.7;cb_enable_damage;".. fgettext("Survival Mode") .. ";" ..
...
function tabbuilder.tab_credits()
	...
	return	"vertlabel[0,-0.5;ABOUT]" ..
			"label[0.5,3;BuyBuild " .. engine.get_version() .. "]" ..
			"label[0.5,3.3;https://buybuild.github.io/]" .. 
			"image[0.5,1;" .. engine.formspec_escape(logofile) .. "]" ..
			"textlist[3.5,-0.25;8.5,5.8;list_credits;" ..
			"#FFFF00" .. fgettext("Staff") .."," ..
			"Yuri Margaryan (Briefiberg) <watevaeatwr@gmail.com>,"..
...
function tabbuilder.init()
	...
	table.insert(tabbuilder.current_buttons,{name="server", caption=fgettext("Multiplayer")})
	...
	table.insert(tabbuilder.current_buttons,{name="credits", caption=fgettext("About")})
